			...
			<div className='flex h-1/5 w-2/5 flex-col items-center justify-between rounded-xl bg-gray-200 p-4'>
				...
				<div className='w-full'>
					<div className='my-2 flex h-12'>
						<button className='w-full rounded-l-3xl border-2 border-r-0 border-gray-800 border-r-black duration-100 ease-linear hover:bg-gray-800 hover:text-white'>
							No, Keep It.
						</button>
						<button className='w-full rounded-r-3xl border-2 border-l-0 border-red-800 border-l-black duration-100 ease-linear hover:bg-red-800 hover:text-white'>
							Yes, Delete!
						</button>
					</div>
				</div>
